...
?>
	<div class="form-container" id="book-add-form-container">
			...
			<form name="book-add-form" method="post" action="book_add.php">
			...
			<div class="input-container block">
				<label for="rack_no">Rack No</label><input name="rack_no" type="text" value="<?php echo $post_flag?$_POST['rack_no']:''  ?>"/>
			</div>
			<div class="input-container block">
				<label for="category">Category</label><input name="category" type="text" value="<?php echo $post_flag?$_POST['category']:'' ?>"/>
			</div>
			<div class="input-container block">
